...
Panel {
  ...
  readonly property string helpText: [
    ...
    "• Speaker icons read original or translation (Google TTS, then espeak-ng). LibreTranslate stays local and uses espeak-ng.",
    "• Paste sends the translation into the focused app.",
    "",
    "Engines",
    "• Google — default. Sends text off-machine.",
    "• MyMemory — free Translated.net API.",
    "• LibreTranslate — local/open source. Never falls back to Google or MyMemory. Point it at a URL you already run (http/https only).",
    "",
    "Toolbar",
    "Swap languages • pin pair • paste into app • auto-copy • clipboard watch • history • this guide • OCR a region.",
    "",
    "Privacy",
    "Same-language text is not sent out. URLs, emails, and common API tokens are redacted. Cache lasts a week. Default engine leaves your machine; speaking uses Google TTS then espeak-ng. LibreTranslate stays on the URL you set (http/https only) and speaks locally.",
    "",
    "Keys in this panel",
