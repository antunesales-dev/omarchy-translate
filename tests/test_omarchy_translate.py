...
class StaticReviewTests(unittest.TestCase):
    ...
    def test_shell_snippets_do_not_concatenate_user_data(self):
        ...
        self.assertNotIn("omarchy pkg add", panel)
        self.assertNotIn("tesseract-data-$1", panel)
        self.assertNotIn("xdg-terminal-exec", panel)
        self.assertIn("Need ffplay, mpv, or espeak-ng", panel)
        self.assertIn('"ocr-langs"', panel)
        self.assertIn('"locale"', panel)
        self.assertIn("ocrPorReady", panel)
        self.assertIn("ocrWanted", panel)
        self.assertIn("ocrTessCode", panel)
        self.assertNotIn("installOcrLang", panel)
